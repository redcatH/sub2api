...
func SetupRouter(
	...
	// 注册路由
	registerRoutes(r, handlers, jwtAuth, optionalJWTAuth, adminAuth, apiKeyAuth, auditLog, stepUpAuth, apiKeyService, subscriptionService, opsService, monitorHub, settingService, compositeResolver, cfg, redisClient)
...
func registerRoutes(
	...
	routes.RegisterGatewayRoutes(r, h, apiKeyAuth, apiKeyService, subscriptionService, opsService, monitorHub, settingService, compositeResolver, cfg)
	routes.RegisterMonitorRoutes(r, monitorHub, apiKeyService)
